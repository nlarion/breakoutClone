...
var LevelConstruct = function(){
  return [
   ...
   ['Inert',650,0,325,100,25,'white',10, ""], ],
    ...
    [ ['Player',200,550,250,65,15,'red',0],
    ['Speedy',775,0,400,25,100,'blue',10, ""],
    ['Steady',0,0,0,25,535,'yellow',10, ""],
    ['Steady',675,0,100,25,435,'yellow',10, ""],
    ['Durable',100,0,50,100,25,'orange',10, ""],
    ['Durable',300,0,150,100,25,'orange',10, ""],
    ['Durable',500,0,50,100,25,'orange',10, ""],
    ['Steady',100,0,375,100,160,'yellow',10, ""],
    ['Steady',500,0,375,100,160,'yellow',10, ""],],
