...
var LevelConstruct = function(){
  return [
    ...
    ['Inert',450,0,75,100,25,'white',10, "extraLife"],
    ['Inert',550,0,75,100,25,'black',10, "newBall"],
    ['Inert',650,0,75,100,25,'white',10, "newBall"],
    ['Inert',50,0,100,100,25,'black',10, "newBall"],
    ['Inert',150,0,100,100,25,'white',10, "newBall"],
    ['Inert',250,0,100,100,25,'black',10, "newBall"],
    ['Inert',350,0,100,100,25,'white',10, "newBall"],
    ['Inert',450,0,100,100,25,'black',10, "newBall"],
    ...
    ['Inert',50,0,100,100,25,'blue',10, ""],
    ['Speedy',150,0,100,100,25,'blue',10, ""],
    ['Speedy',250,0,100,100,25,'blue',10, ""],
    ['Speedy',450,0,100,100,25,'blue',10, ""],
    ['Speedy',550,0,100,100,25,'blue',10, ""],
    ['Speedy',650,0,100,100,25,'blue',10, ""],
    ['Speedy',350,0,100,100,25,'blue',10, ""],],
    ...
    ['Durable',100,0,50,100,25,'red',10, ""],
    ['Durable',300,0,150,100,25,'red',10, ""],
    ['Durable',500,0,50,100,25,'red',10, ""],
